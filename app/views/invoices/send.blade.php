@extends('layouts.default')
	...
	$invoice_email_sbj = $preferences->invoice_send_message_subject;
	$invoice_email = $preferences->invoice_send_message;
...
<h1><a class="do_previous" href="{{ URL::to('dashboard') }}">&nbsp;<i class="fa fa-home">&nbsp;</i></a>&raquo; Sending &raquo; <a href="{{ URL::previous() }}">Invoices</a> &raquo; <a class="to_all" href="{{ URL::to('invoices/'.$invoice->tenant_invoice_id) }}">{{ $preferences->invoice_prefix != "" ? $preferences->invoice_prefix : "" }}{{ Apphelper::invoiceId($invoice->tenant_invoice_id) }} </a></h1>
 ...
 {{ Form::open(array('route' => array('email_invoice', $invoice->tenant_invoice_id) , 'method' => 'post', 'class' => '') ) }}	
	<div id="send_invoice_form">
	    ...
	    <div class="longbox-left more_space">
	    	...
	    	@endif
	             ...
	             <input type="submit" class="gen_btn" id="" name="send_invoice" value="Send" />
