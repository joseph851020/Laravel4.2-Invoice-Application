@extends('layouts.default')
	...
	<h1><a class="do_previous" href="{{ URL::to('dashboard') }}">&nbsp;<i class="fa fa-home">&nbsp;</i></a>&raquo; {{ HTML::linkRoute('quotes', 'Quotes', array(), array('class' => 'to_all')) }} &raquo; Edit</h1>
	@elseif($request_type == 'invoice')
	<h1><a class="do_previous" href="{{ URL::to('dashboard') }}">&nbsp;<i class="fa fa-home">&nbsp;</i></a>&raquo; {{ HTML::linkRoute('invoices', 'Invoices', array(), array('class' => 'to_all')) }} &raquo; Edit</h1>
	@endif
<?php 
	...
	<div class="invoiceTop">
		...
		<div class="invoiceTopLeft">
		 ...
		 @if($request_type == 'invoice')              
			...
			<div class="p-order">
				<input type="text" placeholder=" P.O Number (Optional)" id="p-order" name="po_number" title="P.O Number" value="{{ $invoice->purchase_order_number }}" />
			</div>
		  @endif
...
<?php endif; ?>
	...
	@section('footer')
		...
		<script src="{{ URL::asset('assets/js/edit_invoice.js') }}"></script>
