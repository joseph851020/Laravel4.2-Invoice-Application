@extends('layouts.download')
	...
	// replacement for comma
	 ...
	 // If no tenant invoice ID the check if quote ID id not null and use
 ...
 <h1 class="bg_title"> Invoice </h1>
	 
<div id="invoicecontainer">
  
	 <div class="pdf_logo">
	 	
	 	<?php $tenantID = $invoice->tenantID; $ext = '.png'; $logo_file =  public_path(). '/te_da/'.$tenantID . '/'.$tenantID.$ext; ?>
			 
		@if (file_exists($logo_file))
         <img class="gen_logo_size" src="{{ public_path().'/te_da/'.$tenantID.'/'.$tenantID.'.png' }}" alt="" />
		@endif	
 	</div><!-- END -->
...
<input type="hidden" name="date_format" class="date_format" value="<?php echo $preferences->date_format; ?>" />
	...
	<div class="invoiceTop">
		...
		<div class="invoiceTopLeft">
	 	...
	 	<div id="customer" class="invoice_customer">
            ...
            <?php echo $client->postal_code != "" ? $client->postal_code . "<br />": ""; ?>
       ...
       <div class="paidstamp">
       		<img src="{{ public_path().'/assets/img/stamp/part_paid1.png' }}">
       ...
       <div class="paidstamp">
       		<img src="{{ public_path().'/assets/img/stamp/paid1.png' }}">
       </div><!-- END paidstamp -->
       @endif
 ...
 <div class="">
		<table id="items">
		 ...
		 <tr>
		      <td colspan="{{ $colspan1 }}" class="blank "><h5 class="invoice_note_title">Additional Notes</h5><div class="fornote"><textarea style="height:100%; width:98%;" class="cwl notetext"><?php echo $invoice->note; ?></textarea></div>
