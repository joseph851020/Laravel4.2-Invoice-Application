				              ...
				              <table width="600" border="0" bgcolor="#fff" cellspacing="0" cellpadding="0" style="border-spacing:0;"  class="table_email">
				                <tbody id=""><tr id="">
				                  <td style="border-collapse:collapse;" id="">
				                    <a href="http://www.sighted.com"><img width="170" height="50" style="color:#009999;" alt="Sighted Invoice" src="http://app.sighted.com/integritylogo.png"></a>
				                  </td>
				                </tr>
				              </tbody>
				              </table>
				           ...
				           <tr id="">
				            <td bgcolor="#fff" align="left" style="background-color:#fff;padding-left:10px;padding-right:10px;font-size:12px;line-height:20px;font-family:Helvetica, sans-serif;color:#333;border-collapse:collapse;" class="">
				              ...
				              <table width="580" border="0" bgcolor="#fff" cellspacing="0" cellpadding="0" style="border-spacing:0;" class="" id="">
				                <tbody id="">
				                <!-- <tr id="">
				                  <td align="center" class="" style="border-bottom:1px solid #DAD9D3;border-collapse:collapse;font-size:12px;font-family:Helvetica, sans-serif;padding:15px 0;" id="">
				                    Connect with us:
                                      <a style="color:#0077CC;" href="https://twitter.com/IntegrityNewApp" target="_blank" rel="nofollow">@Sighted Invoice</a> on Twitter,
				                      <a style="color:#0077CC;" href="https://www.facebook.com/integrityinvoice" target="_blank" rel="nofollow">Sighted Invoice</a> on Facebook Page
				                  </td>
				                </tr>				                 -->
				                <tr id="">
				                  <td align="center" class="" style="color:#999999;font-family:Helvetica, sans-serif;font-size:11px;line-height:14px;border-collapse:collapse;padding:15px 0;" id="">
				                    <b>Sighted Invoice</b>
				                    <br> 135 Bryant Street Palo Alto California CA 94301.<br />
                                      Website: <a href="http://www.sighted.com">www.sighted.com</a>
				                  </td>
				                </tr>
				              </tbody>
				              </table>
