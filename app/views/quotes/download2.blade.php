@extends('layouts.download')
 ...
 <h1>{{ HTML::linkRoute('invoices', 'Quotes', array(), array('class' => 'to_all')) }} &raquo;  <span><?php echo AppHelper::invoiceId($l_id); ?></span></h1>
...
<div id="invoicecontainer">
    ...
    <div class="pdf_logo_with_margin">
		...
		@if (file_exists($logo_file))	
			...
			<a href="{{ addhttp($company->website) }}" target="_blank"><img src="{{ Config::get('app.app_domain').'/te_da/'.$tenantID.'/'.$tenantID.'.png' }}" alt="" /></a>
			@else
